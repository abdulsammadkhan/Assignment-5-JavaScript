...
var name,name_last,_pi,firtslast,age123;//legal
var 1name,@nkahn,<laka,>exmp,?this;//illegal
...
var ticketprice=600;
document.write("Total cost to buy 5 tickets toa movie is"+ticketprice*5+"PKR")
...
var gender=prompt("Entret Gender:");
if(gender==="male")
{
...
{
    document.write("Good Morninig Ma'am")

}

//Task#3

var color=prompt("Entret color:");
if(color==="red")
{
...
var liter=+prompt("Enter Fuels in: ");
...
{
    document.write("You have no need to Fuel...")
}
